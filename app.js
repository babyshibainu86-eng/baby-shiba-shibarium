...
function showPage(pageId) {
    ...
    /*
     * Make sure Items are refreshed
     * whenever the player opens the page.
     */
...
function updateShopUI() {
    ...
    /*
     * Optional dynamic item counters.
     * These work if matching elements
     * exist in the HTML.
     */
