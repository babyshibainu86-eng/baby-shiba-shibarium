...
const STORAGE_KEY = "baby_shiba_inu_game_v41";
...
function mine() {
    ...
    /*
     * XP is earned from tapping.
     * Auto mining does NOT give XP.
     */
...
function automaticMiningTick() {
     ...
     * IMPORTANT:
     *
     * Auto mining is deliberately slow.
     *
     * 1 second = current mining rate
     *
     * It DOES NOT:
     * - give XP
...
window.buyEnergyPack =
    buyEnergyPack;

window.buyMiningBoost =
    buyMiningBoost;

window.buyVIP =
    buyVIP;

window.claimVipReward =
    claimVipReward;
